...
public class FutureProductExecutor {
    private int [][] matrix1;
    private int [][] matrix2;
    private int [][] result;
    ...
    public FutureProductExecutor(int[][] matrix1, int[][] matrix2, int[][] result, int nrColsResult, int nrColsMatrix1, int elemStart, int elemEnd, ExecutorService executorService) {
